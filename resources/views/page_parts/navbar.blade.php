<div class="nav_whole">
    <div class="nav_container">
        ...
        <div class="nav_horizontal">
            <img src="{{ asset('images/brand_elements/sea_bunny.png') }}" class="orange_logo">
